// Codeforge template — components/ui/corner-plus.tsx (verbatim, retargeted to our cn util)
...
function CornerPlusSingle({
  ...
  return (
    <>
      <div className={cn("h-px absolute w-3 bg-current z-40", classes.h1, className)} />
      <div className={cn("h-px absolute w-3 bg-current z-40", classes.h2, className)} />
      <div className={cn("w-px absolute h-3 bg-current z-40", classes.v1, className)} />
      <div className={cn("w-px absolute h-3 bg-current z-40", classes.v2, className)} />
    </>
  );
}
