...
export function FeatureCard8({
  title = "Reply",
  description = "Reply to other creators in app",
  ...
  return (
    <div className="relative mx-auto h-full w-full max-w-[32rem] transform-gpu rounded-lg border bg-white [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] md:max-h-[500px] dark:bg-black dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] dark:[border:1px_solid_rgba(255,255,255,.1)]">
      <motion.div
        ...
        <div className="flex h-full w-full cursor-pointer flex-col items-center justify-center gap-y-1 overflow-hidden rounded-t-xl bg-transparent">
          <div className="relative flex flex-col items-center justify-center gap-y-2 px-10 py-20">
            ...
            >
              ...
              <motion.p
                variants={variant3}
                className="highlighted absolute right-2 -bottom-2 w-fit rounded-full border bg-cyan-500 px-2 py-0.5 text-xs text-white"
              >
                sent
              </motion.p>
            </motion.div>
